...
@section('content')
    ...
    <div id="hero" class="px-4 py-5 text-center">
        <h1 class="display-5 fw-bold">GHealth</h1>
        <div class="col-lg-6 mx-auto">
            ...
            <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                <a href="/login" target="_blank"><button type="button" class="btn btn-primary btn-lg px-4 gap-3">Get Started</button></a>
            </div>
        </div>
    </div>
    <!-- End Hero -->
    ...
    <div class="container px-4 py-5" id="about">
        <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
            <div class="col-10 col-sm-8 col-lg-6">
                <img src="img/anu.png" style="width: 100%; height: 90%;"
                    class="d-block mx-lg-auto img-fluid" loading="lazy" style="width: 100%; height:50%;">
            </div>
            <div class="col-lg-6">
                <h2 class="display-5 fw-bold lh-1 mb-3">About G-Health</h2>
                <p class="lead">G-Health merupakan platfrom khusus yang disediakan bagi masyarakat luas yang ingin menenangkan diri dan pikiran. G-Health sendiri memberikan
                    beberapa pelayanan yang dapat digunakan oleh para pengguna aplikasi tersebut.
                </p>
            </div>
        </div>
    </div>
    ...
    <div id="team" class="team team-bg py-5" style="background-image: url('/img/bg7.jpeg')">
        <div class="container">
